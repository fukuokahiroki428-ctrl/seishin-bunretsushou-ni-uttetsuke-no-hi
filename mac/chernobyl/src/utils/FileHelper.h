...
// ★ 어느 파일시스템에 저장해도 같은 이름이 되게 다듬는다 (윈도우판 4b87220 과 같은 규칙).
...
//                          (맥 Qt 는 디스크에 어차피 NFD 로 적으므로, 디스크 쪽은
//                           수집 끝의 normalizeNamesToNfc 가 맞춘다. 이것은 엑셀·목록에
//                           적히는 문자열을 처음부터 NFC 로 두는 몫이다.)
